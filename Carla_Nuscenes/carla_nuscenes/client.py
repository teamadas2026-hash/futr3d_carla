...
class Client:
    ...
    def _spawn_walkers(self,count,ego_location=None):
        ...
        # Fix for CARLA issue #7092: AIWalkerController disables physics/collisions
        # on walkers in 0.9.15+, making them invisible to LiDAR. Re-enable them.
        self.world.tick()
        for walker in walkers:
            actor = walker.get_actor()
