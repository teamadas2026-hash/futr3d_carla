...
def create_nuscenes_infos(root_path,
    ...
    available_vers = ['v1.0-trainval', 'v1.0-test', 'v1.0-mini', 'v1.0-carla']
    ...
    if version == 'v1.0-trainval':
        ...
        # Dynamic split — reads scenes from nusc instance and shuffles them
        carla_splits = create_splits_scenes(nusc=nusc)
        train_scenes = carla_splits['mini_train']
        val_scenes   = carla_splits['mini_val']
    else:
        raise ValueError('unknown')
